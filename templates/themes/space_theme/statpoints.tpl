...
<input type="submit" class="button" name="stat" value="{$LANGUAGE_Strength}" />
</form>
...
<form method="post" action="index.php?mod=StatPoints">
<input type="submit" class="button" name="stat" value="{$LANGUAGE_Vitality}" />
</form>
...
<form method="post" action="index.php?mod=StatPoints">
<input type="submit" class="button" name="stat" value="{$LANGUAGE_Agility}" />
</form>
...
<form method="post" action="index.php?mod=StatPoints">
<input type="submit" class="button" name="stat" value="{$LANGUAGE_Dexterity}" />
</form>
